...
static gconstpointer
_get_fcn_ethtool_feature (ARGS_GET_FCN)
{
	const char *s;
	NMTernary val;
...
static gboolean
_set_fcn_ethtool_feature (ARGS_SET_FCN)
{
	gs_free char *value_to_free = NULL;
	NMTernary val;
	NMEthtoolID ethtool_id = property_info->property_typ_data->subtype.ethtool.ethtool_id;
...
static const char *const*
_complete_fcn_ethtool_feature (ARGS_COMPLETE_FCN)
{
	static const char *const v[] = {
		"true",
		"false",
...
static gconstpointer
_get_fcn_ethtool_coalesce (ARGS_GET_FCN)
{
	const char *s;
	NMEthtoolID ethtool_id = property_info->property_typ_data->subtype.ethtool.ethtool_id;
	...
	s = nm_setting_ethtool_get_coalesce (NM_SETTING_ETHTOOL (setting),
	                                     nm_ethtool_data[ethtool_id]->optname);
...
static gboolean
_set_fcn_ethtool_coalesce (ARGS_SET_FCN)
{
	NMEthtoolID ethtool_id = property_info->property_typ_data->subtype.ethtool.ethtool_id;
...
static const NMMetaPropertyType _pt_ethtool_feature = {
	.get_fcn =                      _get_fcn_ethtool_feature,
	.set_fcn =                      _set_fcn_ethtool_feature,
	.complete_fcn =                 _complete_fcn_ethtool_feature,
};

static const NMMetaPropertyType _pt_ethtool_coalesce = {
	.get_fcn =                      _get_fcn_ethtool_coalesce,
	.set_fcn =                      _set_fcn_ethtool_coalesce,
};
...
#define PROPERTY_INFO_ETHTOOL_FEATURE(xname) \
	PROPERTY_INFO (NM_ETHTOOL_OPTNAME_##xname, NULL, \
	    .property_type = &_pt_ethtool_feature, \
	    .hide_if_default = TRUE, \
...
#define PROPERTY_INFO_ETHTOOL_COALESCE(xname, ...) \
	PROPERTY_INFO (NM_ETHTOOL_OPTNAME_##xname, NULL, \
	    .property_type = &_pt_ethtool_coalesce, \
	    .hide_if_default = TRUE, \
	    .property_typ_data = DEFINE_PROPERTY_TYP_DATA_SUBTYPE (ethtool, \
	        .ethtool_id = NM_ETHTOOL_ID_##xname, \
	    ), \
...
static const NMMetaPropertyInfo *const property_infos_ETHTOOL[] = {
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_ESP_HW_OFFLOAD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_ESP_TX_CSUM_HW_OFFLOAD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_FCOE_MTU),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_GRO),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_GSO),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_HIGHDMA),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_HW_TC_OFFLOAD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_L2_FWD_OFFLOAD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_LOOPBACK),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_LRO),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_NTUPLE),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RXHASH),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RXVLAN),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_ALL),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_FCS),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_GRO_HW),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_UDP_TUNNEL_PORT_OFFLOAD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_VLAN_FILTER),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_VLAN_STAG_FILTER),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_RX_VLAN_STAG_HW_PARSE),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_SG),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TLS_HW_RECORD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TLS_HW_TX_OFFLOAD),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TSO),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TXVLAN),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_CHECKSUM_FCOE_CRC),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_CHECKSUM_IPV4),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_CHECKSUM_IPV6),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_CHECKSUM_IP_GENERIC),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_CHECKSUM_SCTP),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_ESP_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_FCOE_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_GRE_CSUM_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_GRE_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_GSO_PARTIAL),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_GSO_ROBUST),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_IPXIP4_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_IPXIP6_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_NOCACHE_COPY),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_SCATTER_GATHER),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_SCATTER_GATHER_FRAGLIST),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_SCTP_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_TCP6_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_TCP_ECN_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_TCP_MANGLEID_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_TCP_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_UDP_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_UDP_TNL_CSUM_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_UDP_TNL_SEGMENTATION),
	PROPERTY_INFO_ETHTOOL_FEATURE (FEATURE_TX_VLAN_STAG_HW_INSERT),
	PROPERTY_INFO_ETHTOOL_COALESCE (COALESCE_ADAPTIVE_RX),
	PROPERTY_INFO_ETHTOOL_COALESCE (COALESCE_ADAPTIVE_TX),
	NULL,
};
