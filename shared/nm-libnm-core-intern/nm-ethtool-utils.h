...
typedef enum {
	...
	NM_ETHTOOL_ID_COALESCE_ADAPTIVE_RX = _NM_ETHTOOL_ID_FIRST,
	...
	_NM_ETHTOOL_ID_COALESCE_FIRST = NM_ETHTOOL_ID_COALESCE_ADAPTIVE_RX,
	_NM_ETHTOOL_ID_COALESCE_LAST = NM_ETHTOOL_ID_COALESCE_ADAPTIVE_TX,
	_NM_ETHTOOL_ID_COALESCE_NUM = (_NM_ETHTOOL_ID_COALESCE_LAST - _NM_ETHTOOL_ID_COALESCE_FIRST + 1),

	_NM_ETHTOOL_ID_FEATURE_FIRST = NM_ETHTOOL_ID_FEATURE_ESP_HW_OFFLOAD,
